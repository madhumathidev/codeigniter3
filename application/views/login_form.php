        ...
        <nav class="navbar navbar-dark bg-dark navbar-expand-lg fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li clas="navbar-item">
                        <a class="nav-link btn btn-default" href="" data-toggle="modal" data-target="#loginModal"
                            id="btnLogin">Login</a>
                    </li>
                </ul>
            </div>
                                ...
                                <form id="login-form" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-4 col-sm-6 col-12 mx-auto">
                                            <input type="submit" name="submit" class="btn  btn_size btn-primary"
                                                value="submit">

                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h6>Don't have an account,<a href="" data-toggle="modal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-column text-center">
                            <form>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-4 col-sm-6 col-12 mx-auto">
                                        <button type="submit" name="submit" class="btn btn_size btn-primary">Sign
                                            in</button>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <h6>Already have an account <a href="" data-toggle="modal"
                                            data-target="#loginModal">Sign in</a></h6>
                                </div>
                                <div class="mt-3">
